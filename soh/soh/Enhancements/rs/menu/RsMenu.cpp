...
//   - #128, the same day again: 2 more, so the right roll sits as far below the C-down button as the
//     parchment's middle sits below the stepper - 7 in the scroll's own units (the stepper's bottom at 41,
//     the parchment's top at kPanelY0, 48). Measured at 10 (docs/test-runs/2026-09-24-issue-128-stepper,

#include "CustomCastleCamBothScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader castle_cam_both_scene_collisionHeader;
    extern RoomShapeNormal castle_cam_both_room_0_shapeHeader;
...
static EnvLightSettings sCastleCamBothLightSettings[4] = {
...
static EntranceEntry sCastleCamBothEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sCastleCamBothPlayerSpawn = {
    ACTOR_PLAYER, { 220, 0, -240 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sCastleCamBothRoomList[] = {
    { (uintptr_t)&castle_cam_both_room_0_shapeHeader,
      (uintptr_t)&castle_cam_both_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomCastleCamBothScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_CASTLE_CAM_BOTH;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &castle_cam_both_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sCastleCamBothRoomList;

    play->setupEntranceList = sCastleCamBothEntrances;
    play->linkActorEntry    = &sCastleCamBothPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sCastleCamBothLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomCastleCamBothScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&castle_cam_both_room_0_shapeHeader;
...
extern "C" int CustomCastleCamBothScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_CASTLE_CAM_BOTH) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomCastleCamBothScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

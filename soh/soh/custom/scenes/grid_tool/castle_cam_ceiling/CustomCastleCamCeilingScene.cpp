#include "CustomCastleCamCeilingScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader castle_cam_ceiling_scene_collisionHeader;
    extern RoomShapeNormal castle_cam_ceiling_room_0_shapeHeader;
...
static EnvLightSettings sCastleCamCeilingLightSettings[4] = {
...
static EntranceEntry sCastleCamCeilingEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sCastleCamCeilingPlayerSpawn = {
    ACTOR_PLAYER, { 220, 0, -240 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sCastleCamCeilingRoomList[] = {
    { (uintptr_t)&castle_cam_ceiling_room_0_shapeHeader,
      (uintptr_t)&castle_cam_ceiling_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomCastleCamCeilingScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_CASTLE_CAM_CEILING;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &castle_cam_ceiling_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sCastleCamCeilingRoomList;

    play->setupEntranceList = sCastleCamCeilingEntrances;
    play->linkActorEntry    = &sCastleCamCeilingPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sCastleCamCeilingLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomCastleCamCeilingScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&castle_cam_ceiling_room_0_shapeHeader;
...
extern "C" int CustomCastleCamCeilingScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_CASTLE_CAM_CEILING) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomCastleCamCeilingScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

#include "CustomCastleCamSlabScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader castle_cam_slab_scene_collisionHeader;
    extern RoomShapeNormal castle_cam_slab_room_0_shapeHeader;
...
static EnvLightSettings sCastleCamSlabLightSettings[4] = {
...
static EntranceEntry sCastleCamSlabEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sCastleCamSlabPlayerSpawn = {
    ACTOR_PLAYER, { 220, 0, -240 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sCastleCamSlabRoomList[] = {
    { (uintptr_t)&castle_cam_slab_room_0_shapeHeader,
      (uintptr_t)&castle_cam_slab_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomCastleCamSlabScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_CASTLE_CAM_SLAB;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &castle_cam_slab_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sCastleCamSlabRoomList;

    play->setupEntranceList = sCastleCamSlabEntrances;
    play->linkActorEntry    = &sCastleCamSlabPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sCastleCamSlabLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomCastleCamSlabScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&castle_cam_slab_room_0_shapeHeader;
...
extern "C" int CustomCastleCamSlabScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_CASTLE_CAM_SLAB) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomCastleCamSlabScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

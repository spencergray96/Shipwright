#include "CustomGridTestMap10Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader grid_test_map_10_scene_collisionHeader;
    extern RoomShapeNormal grid_test_map_10_room_0_shapeHeader;
...
static EnvLightSettings sGridTestMap10LightSettings[4] = {
...
static EntranceEntry sGridTestMap10Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sGridTestMap10PlayerSpawn = {
    ACTOR_PLAYER, { 100, 0, -140 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sGridTestMap10RoomList[] = {
    { (uintptr_t)&grid_test_map_10_room_0_shapeHeader,
      (uintptr_t)&grid_test_map_10_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomGridTestMap10Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_GRID_TEST_MAP_10;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &grid_test_map_10_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sGridTestMap10RoomList;

    play->setupEntranceList = sGridTestMap10Entrances;
    play->linkActorEntry    = &sGridTestMap10PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sGridTestMap10LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomGridTestMap10Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&grid_test_map_10_room_0_shapeHeader;
...
extern "C" int CustomGridTestMap10Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_GRID_TEST_MAP_10) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomGridTestMap10Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

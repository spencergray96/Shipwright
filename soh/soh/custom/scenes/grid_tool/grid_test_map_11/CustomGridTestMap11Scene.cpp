#include "CustomGridTestMap11Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader grid_test_map_11_scene_collisionHeader;
    extern RoomShapeNormal grid_test_map_11_room_0_shapeHeader;
...
static EnvLightSettings sGridTestMap11LightSettings[4] = {
...
static EntranceEntry sGridTestMap11Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sGridTestMap11PlayerSpawn = {
    ACTOR_PLAYER, { 75, 0, -105 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sGridTestMap11RoomList[] = {
    { (uintptr_t)&grid_test_map_11_room_0_shapeHeader,
      (uintptr_t)&grid_test_map_11_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomGridTestMap11Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_GRID_TEST_MAP_11;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &grid_test_map_11_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sGridTestMap11RoomList;

    play->setupEntranceList = sGridTestMap11Entrances;
    play->linkActorEntry    = &sGridTestMap11PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sGridTestMap11LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomGridTestMap11Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
...
extern "C" int CustomGridTestMap11Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_GRID_TEST_MAP_11) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomGridTestMap11Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

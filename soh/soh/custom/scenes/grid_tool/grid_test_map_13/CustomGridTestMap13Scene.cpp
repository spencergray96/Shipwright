#include "CustomGridTestMap13Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader grid_test_map_13_scene_collisionHeader;
    extern RoomShapeNormal grid_test_map_13_room_0_shapeHeader;
...
static EnvLightSettings sGridTestMap13LightSettings[4] = {
...
static EntranceEntry sGridTestMap13Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sGridTestMap13PlayerSpawn = {
    ACTOR_PLAYER, { 88, 0, -122 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sGridTestMap13RoomList[] = {
    { (uintptr_t)&grid_test_map_13_room_0_shapeHeader,
      (uintptr_t)&grid_test_map_13_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomGridTestMap13Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_GRID_TEST_MAP_13;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &grid_test_map_13_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sGridTestMap13RoomList;

    play->setupEntranceList = sGridTestMap13Entrances;
    play->linkActorEntry    = &sGridTestMap13PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sGridTestMap13LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomGridTestMap13Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&grid_test_map_13_room_0_shapeHeader;
...
extern "C" int CustomGridTestMap13Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_GRID_TEST_MAP_13) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomGridTestMap13Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

#include "CustomGridTestMap14Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader grid_test_map_14_scene_collisionHeader;
    extern RoomShapeNormal grid_test_map_14_room_0_shapeHeader;
...
static EnvLightSettings sGridTestMap14LightSettings[4] = {
...
static EntranceEntry sGridTestMap14Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sGridTestMap14PlayerSpawn = {
    ACTOR_PLAYER, { 18, 74, 53 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sGridTestMap14RoomList[] = {
    { (uintptr_t)&grid_test_map_14_room_0_shapeHeader,
      (uintptr_t)&grid_test_map_14_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomGridTestMap14Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_GRID_TEST_MAP_14;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &grid_test_map_14_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sGridTestMap14RoomList;

    play->setupEntranceList = sGridTestMap14Entrances;
    play->linkActorEntry    = &sGridTestMap14PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sGridTestMap14LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomGridTestMap14Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&grid_test_map_14_room_0_shapeHeader;
...
extern "C" int CustomGridTestMap14Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_GRID_TEST_MAP_14) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomGridTestMap14Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

#include "CustomGridTestMap2Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader grid_test_map_2_scene_collisionHeader;
    extern RoomShapeNormal grid_test_map_2_room_0_shapeHeader;
...
static EnvLightSettings sGridTestMap2LightSettings[4] = {
...
static EntranceEntry sGridTestMap2Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sGridTestMap2PlayerSpawn = {
    ACTOR_PLAYER, { 500, 0, -900 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sGridTestMap2RoomList[] = {
    { (uintptr_t)&grid_test_map_2_room_0_shapeHeader,
      (uintptr_t)&grid_test_map_2_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomGridTestMap2Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_GRID_TEST_MAP_2;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &grid_test_map_2_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sGridTestMap2RoomList;

    play->setupEntranceList = sGridTestMap2Entrances;
    play->linkActorEntry    = &sGridTestMap2PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sGridTestMap2LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomGridTestMap2Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&grid_test_map_2_room_0_shapeHeader;
...
extern "C" int CustomGridTestMap2Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_GRID_TEST_MAP_2) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomGridTestMap2Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

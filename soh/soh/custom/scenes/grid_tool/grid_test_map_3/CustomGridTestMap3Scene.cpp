#include "CustomGridTestMap3Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader grid_test_map_3_scene_collisionHeader;
    extern RoomShapeNormal grid_test_map_3_room_0_shapeHeader;
...
static EnvLightSettings sGridTestMap3LightSettings[4] = {
...
static EntranceEntry sGridTestMap3Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sGridTestMap3PlayerSpawn = {
    ACTOR_PLAYER, { 200, 0, -280 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sGridTestMap3RoomList[] = {
    { (uintptr_t)&grid_test_map_3_room_0_shapeHeader,
      (uintptr_t)&grid_test_map_3_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomGridTestMap3Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_GRID_TEST_MAP_3;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &grid_test_map_3_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sGridTestMap3RoomList;

    play->setupEntranceList = sGridTestMap3Entrances;
    play->linkActorEntry    = &sGridTestMap3PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sGridTestMap3LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomGridTestMap3Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&grid_test_map_3_room_0_shapeHeader;
...
extern "C" int CustomGridTestMap3Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_GRID_TEST_MAP_3) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomGridTestMap3Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

#include "CustomGridTestMap8Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader grid_test_map_8_scene_collisionHeader;
    extern RoomShapeNormal grid_test_map_8_room_0_shapeHeader;
...
static EnvLightSettings sGridTestMap8LightSettings[4] = {
...
static EntranceEntry sGridTestMap8Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sGridTestMap8PlayerSpawn = {
    ACTOR_PLAYER, { 150, 0, -210 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sGridTestMap8RoomList[] = {
    { (uintptr_t)&grid_test_map_8_room_0_shapeHeader,
      (uintptr_t)&grid_test_map_8_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomGridTestMap8Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_GRID_TEST_MAP_8;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &grid_test_map_8_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sGridTestMap8RoomList;

    play->setupEntranceList = sGridTestMap8Entrances;
    play->linkActorEntry    = &sGridTestMap8PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sGridTestMap8LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomGridTestMap8Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&grid_test_map_8_room_0_shapeHeader;
...
extern "C" int CustomGridTestMap8Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_GRID_TEST_MAP_8) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomGridTestMap8Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

#include "CustomGridTestMap9Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader grid_test_map_9_scene_collisionHeader;
    extern RoomShapeNormal grid_test_map_9_room_0_shapeHeader;
...
static EnvLightSettings sGridTestMap9LightSettings[4] = {
...
static EntranceEntry sGridTestMap9Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sGridTestMap9PlayerSpawn = {
    ACTOR_PLAYER, { 125, 0, -175 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sGridTestMap9RoomList[] = {
    { (uintptr_t)&grid_test_map_9_room_0_shapeHeader,
      (uintptr_t)&grid_test_map_9_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomGridTestMap9Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_GRID_TEST_MAP_9;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &grid_test_map_9_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sGridTestMap9RoomList;

    play->setupEntranceList = sGridTestMap9Entrances;
    play->linkActorEntry    = &sGridTestMap9PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sGridTestMap9LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomGridTestMap9Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&grid_test_map_9_room_0_shapeHeader;
...
extern "C" int CustomGridTestMap9Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_GRID_TEST_MAP_9) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomGridTestMap9Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

#include "CustomLedgeHopRetestScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader ledge_hop_retest_scene_collisionHeader;
    extern RoomShapeNormal ledge_hop_retest_room_0_shapeHeader;
...
static EnvLightSettings sLedgeHopRetestLightSettings[4] = {
...
static EntranceEntry sLedgeHopRetestEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sLedgeHopRetestPlayerSpawn = {
    ACTOR_PLAYER, { 105, 74, -297 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sLedgeHopRetestRoomList[] = {
    { (uintptr_t)&ledge_hop_retest_room_0_shapeHeader,
      (uintptr_t)&ledge_hop_retest_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomLedgeHopRetestScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_LEDGE_HOP_RETEST;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &ledge_hop_retest_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sLedgeHopRetestRoomList;

    play->setupEntranceList = sLedgeHopRetestEntrances;
    play->linkActorEntry    = &sLedgeHopRetestPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sLedgeHopRetestLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomLedgeHopRetestScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&ledge_hop_retest_room_0_shapeHeader;
...
extern "C" int CustomLedgeHopRetestScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_LEDGE_HOP_RETEST) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomLedgeHopRetestScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

#include "CustomLumbridgeCastleTest1Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader lumbridge_castle_test_1_scene_collisionHeader;
    extern RoomShapeNormal lumbridge_castle_test_1_room_0_shapeHeader;
...
static EnvLightSettings sLumbridgeCastleTest1LightSettings[4] = {
...
static EntranceEntry sLumbridgeCastleTest1Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sLumbridgeCastleTest1PlayerSpawn = {
    ACTOR_PLAYER, { -192, 0, -52 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sLumbridgeCastleTest1RoomList[] = {
    { (uintptr_t)&lumbridge_castle_test_1_room_0_shapeHeader,
      (uintptr_t)&lumbridge_castle_test_1_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomLumbridgeCastleTest1Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_LUMBRIDGE_CASTLE_TEST_1;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &lumbridge_castle_test_1_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sLumbridgeCastleTest1RoomList;

    play->setupEntranceList = sLumbridgeCastleTest1Entrances;
    play->linkActorEntry    = &sLumbridgeCastleTest1PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sLumbridgeCastleTest1LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomLumbridgeCastleTest1Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&lumbridge_castle_test_1_room_0_shapeHeader;
...
extern "C" int CustomLumbridgeCastleTest1Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_LUMBRIDGE_CASTLE_TEST_1) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomLumbridgeCastleTest1Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

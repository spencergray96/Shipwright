#include "CustomLumbridgeLintelHalfScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader lumbridge_lintel_half_scene_collisionHeader;
    extern RoomShapeNormal lumbridge_lintel_half_room_0_shapeHeader;
...
static EnvLightSettings sLumbridgeLintelHalfLightSettings[4] = {
...
static EntranceEntry sLumbridgeLintelHalfEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sLumbridgeLintelHalfPlayerSpawn = {
    ACTOR_PLAYER, { 740, 244, -200 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sLumbridgeLintelHalfRoomList[] = {
    { (uintptr_t)&lumbridge_lintel_half_room_0_shapeHeader,
      (uintptr_t)&lumbridge_lintel_half_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomLumbridgeLintelHalfScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_LUMBRIDGE_LINTEL_HALF;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &lumbridge_lintel_half_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sLumbridgeLintelHalfRoomList;

    play->setupEntranceList = sLumbridgeLintelHalfEntrances;
    play->linkActorEntry    = &sLumbridgeLintelHalfPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sLumbridgeLintelHalfLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomLumbridgeLintelHalfScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&lumbridge_lintel_half_room_0_shapeHeader;
...
extern "C" int CustomLumbridgeLintelHalfScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_LUMBRIDGE_LINTEL_HALF) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomLumbridgeLintelHalfScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

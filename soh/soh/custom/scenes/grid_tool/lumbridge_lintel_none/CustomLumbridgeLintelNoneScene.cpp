#include "CustomLumbridgeLintelNoneScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader lumbridge_lintel_none_scene_collisionHeader;
    extern RoomShapeNormal lumbridge_lintel_none_room_0_shapeHeader;
...
static EnvLightSettings sLumbridgeLintelNoneLightSettings[4] = {
...
static EntranceEntry sLumbridgeLintelNoneEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sLumbridgeLintelNonePlayerSpawn = {
    ACTOR_PLAYER, { 740, 244, -200 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sLumbridgeLintelNoneRoomList[] = {
    { (uintptr_t)&lumbridge_lintel_none_room_0_shapeHeader,
      (uintptr_t)&lumbridge_lintel_none_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomLumbridgeLintelNoneScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_LUMBRIDGE_LINTEL_NONE;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &lumbridge_lintel_none_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sLumbridgeLintelNoneRoomList;

    play->setupEntranceList = sLumbridgeLintelNoneEntrances;
    play->linkActorEntry    = &sLumbridgeLintelNonePlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sLumbridgeLintelNoneLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomLumbridgeLintelNoneScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&lumbridge_lintel_none_room_0_shapeHeader;
...
extern "C" int CustomLumbridgeLintelNoneScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_LUMBRIDGE_LINTEL_NONE) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomLumbridgeLintelNoneScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

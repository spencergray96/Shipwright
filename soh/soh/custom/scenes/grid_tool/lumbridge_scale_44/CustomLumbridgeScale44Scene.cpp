#include "CustomLumbridgeScale44Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader lumbridge_scale_44_scene_collisionHeader;
    extern RoomShapeNormal lumbridge_scale_44_room_0_shapeHeader;
...
static EnvLightSettings sLumbridgeScale44LightSettings[4] = {
...
static EntranceEntry sLumbridgeScale44Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sLumbridgeScale44PlayerSpawn = {
    ACTOR_PLAYER, { 814, 268, -220 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sLumbridgeScale44RoomList[] = {
    { (uintptr_t)&lumbridge_scale_44_room_0_shapeHeader,
      (uintptr_t)&lumbridge_scale_44_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomLumbridgeScale44Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_LUMBRIDGE_SCALE_44;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &lumbridge_scale_44_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sLumbridgeScale44RoomList;

    play->setupEntranceList = sLumbridgeScale44Entrances;
    play->linkActorEntry    = &sLumbridgeScale44PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sLumbridgeScale44LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomLumbridgeScale44Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&lumbridge_scale_44_room_0_shapeHeader;
...
extern "C" int CustomLumbridgeScale44Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_LUMBRIDGE_SCALE_44) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomLumbridgeScale44Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

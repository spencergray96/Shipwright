#include "CustomLumbridgeSettlementX3Scene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader lumbridge_settlement_x3_scene_collisionHeader;
    extern RoomShapeNormal lumbridge_settlement_x3_room_0_shapeHeader;
...
static EnvLightSettings sLumbridgeSettlementX3LightSettings[4] = {
...
static EntranceEntry sLumbridgeSettlementX3Entrances[] = {
    { 0, 0 },
};
...
static ActorEntry sLumbridgeSettlementX3PlayerSpawn = {
    ACTOR_PLAYER, { 220, 0, -240 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sLumbridgeSettlementX3RoomList[] = {
    { (uintptr_t)&lumbridge_settlement_x3_room_0_shapeHeader,
      (uintptr_t)&lumbridge_settlement_x3_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomLumbridgeSettlementX3Scene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_LUMBRIDGE_SETTLEMENT_X3;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &lumbridge_settlement_x3_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sLumbridgeSettlementX3RoomList;

    play->setupEntranceList = sLumbridgeSettlementX3Entrances;
    play->linkActorEntry    = &sLumbridgeSettlementX3PlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sLumbridgeSettlementX3LightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomLumbridgeSettlementX3Scene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&lumbridge_settlement_x3_room_0_shapeHeader;
...
extern "C" int CustomLumbridgeSettlementX3Scene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_LUMBRIDGE_SETTLEMENT_X3) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomLumbridgeSettlementX3Scene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

#include "CustomRsPropsP2HostScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader rs_props_p2_host_scene_collisionHeader;
    extern RoomShapeNormal rs_props_p2_host_room_0_shapeHeader;
...
static EnvLightSettings sRsPropsP2HostLightSettings[4] = {
...
static EntranceEntry sRsPropsP2HostEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sRsPropsP2HostPlayerSpawn = {
    ACTOR_PLAYER, { 100, 0, -140 }, { 0, 0, 0 }, 0xDFF
};

static RomFile sRsPropsP2HostRoomList[] = {
    { (uintptr_t)&rs_props_p2_host_room_0_shapeHeader,
      (uintptr_t)&rs_props_p2_host_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomRsPropsP2HostScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_RS_PROPS_P2_HOST;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &rs_props_p2_host_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sRsPropsP2HostRoomList;

    play->setupEntranceList = sRsPropsP2HostEntrances;
    play->linkActorEntry    = &sRsPropsP2HostPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sRsPropsP2HostLightSettings;
...
extern "C" int CustomRsPropsP2HostScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_RS_PROPS_P2_HOST) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomRsPropsP2HostScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

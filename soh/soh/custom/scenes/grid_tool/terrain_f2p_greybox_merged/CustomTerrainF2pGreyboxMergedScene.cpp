#include "CustomTerrainF2pGreyboxMergedScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader terrain_f2p_greybox_merged_scene_collisionHeader;
    extern RoomShapeNormal terrain_f2p_greybox_merged_room_0_shapeHeader;
...
static EnvLightSettings sTerrainF2pGreyboxMergedLightSettings[4] = {
...
static EntranceEntry sTerrainF2pGreyboxMergedEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sTerrainF2pGreyboxMergedPlayerSpawn = {
    ACTOR_PLAYER, { -6640, 13, -2960 }, { 0, -32768, 0 }, 0xDFF
};

static RomFile sTerrainF2pGreyboxMergedRoomList[] = {
    { (uintptr_t)&terrain_f2p_greybox_merged_room_0_shapeHeader,
      (uintptr_t)&terrain_f2p_greybox_merged_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomTerrainF2pGreyboxMergedScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_TERRAIN_F2P_GREYBOX_MERGED;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &terrain_f2p_greybox_merged_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sTerrainF2pGreyboxMergedRoomList;

    play->setupEntranceList = sTerrainF2pGreyboxMergedEntrances;
    play->linkActorEntry    = &sTerrainF2pGreyboxMergedPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sTerrainF2pGreyboxMergedLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomTerrainF2pGreyboxMergedScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&terrain_f2p_greybox_merged_room_0_shapeHeader;
...
extern "C" int CustomTerrainF2pGreyboxMergedScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_TERRAIN_F2P_GREYBOX_MERGED) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomTerrainF2pGreyboxMergedScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

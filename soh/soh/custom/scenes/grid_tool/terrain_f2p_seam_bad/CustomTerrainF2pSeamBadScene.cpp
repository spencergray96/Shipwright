#include "CustomTerrainF2pSeamBadScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader terrain_f2p_seam_bad_scene_collisionHeader;
    extern RoomShapeNormal terrain_f2p_seam_bad_room_0_shapeHeader;
...
static EnvLightSettings sTerrainF2pSeamBadLightSettings[4] = {
...
static EntranceEntry sTerrainF2pSeamBadEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sTerrainF2pSeamBadPlayerSpawn = {
    ACTOR_PLAYER, { -6640, 13, -2960 }, { 0, -32768, 0 }, 0xDFF
};

static RomFile sTerrainF2pSeamBadRoomList[] = {
    { (uintptr_t)&terrain_f2p_seam_bad_room_0_shapeHeader,
      (uintptr_t)&terrain_f2p_seam_bad_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomTerrainF2pSeamBadScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_TERRAIN_F2P_SEAM_BAD;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &terrain_f2p_seam_bad_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sTerrainF2pSeamBadRoomList;

    play->setupEntranceList = sTerrainF2pSeamBadEntrances;
    play->linkActorEntry    = &sTerrainF2pSeamBadPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sTerrainF2pSeamBadLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomTerrainF2pSeamBadScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&terrain_f2p_seam_bad_room_0_shapeHeader;
...
extern "C" int CustomTerrainF2pSeamBadScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_TERRAIN_F2P_SEAM_BAD) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomTerrainF2pSeamBadScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

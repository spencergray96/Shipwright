#include "CustomTerrainF2pSeamGoodScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader terrain_f2p_seam_good_scene_collisionHeader;
    extern RoomShapeNormal terrain_f2p_seam_good_room_0_shapeHeader;
...
static EnvLightSettings sTerrainF2pSeamGoodLightSettings[4] = {
...
static EntranceEntry sTerrainF2pSeamGoodEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sTerrainF2pSeamGoodPlayerSpawn = {
    ACTOR_PLAYER, { -6640, 13, -2960 }, { 0, -32768, 0 }, 0xDFF
};

static RomFile sTerrainF2pSeamGoodRoomList[] = {
    { (uintptr_t)&terrain_f2p_seam_good_room_0_shapeHeader,
      (uintptr_t)&terrain_f2p_seam_good_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomTerrainF2pSeamGoodScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_TERRAIN_F2P_SEAM_GOOD;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &terrain_f2p_seam_good_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sTerrainF2pSeamGoodRoomList;

    play->setupEntranceList = sTerrainF2pSeamGoodEntrances;
    play->linkActorEntry    = &sTerrainF2pSeamGoodPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sTerrainF2pSeamGoodLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomTerrainF2pSeamGoodScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&terrain_f2p_seam_good_room_0_shapeHeader;
...
extern "C" int CustomTerrainF2pSeamGoodScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_TERRAIN_F2P_SEAM_GOOD) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomTerrainF2pSeamGoodScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

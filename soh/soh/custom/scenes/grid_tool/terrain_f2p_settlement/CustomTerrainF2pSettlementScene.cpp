#include "CustomTerrainF2pSettlementScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader terrain_f2p_settlement_scene_collisionHeader;
    extern RoomShapeNormal terrain_f2p_settlement_room_0_shapeHeader;
...
static EnvLightSettings sTerrainF2pSettlementLightSettings[4] = {
...
static EntranceEntry sTerrainF2pSettlementEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sTerrainF2pSettlementPlayerSpawn = {
    ACTOR_PLAYER, { -6640, 13, -2960 }, { 0, -32768, 0 }, 0xDFF
};

static RomFile sTerrainF2pSettlementRoomList[] = {
    { (uintptr_t)&terrain_f2p_settlement_room_0_shapeHeader,
      (uintptr_t)&terrain_f2p_settlement_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomTerrainF2pSettlementScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_TERRAIN_F2P_SETTLEMENT;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &terrain_f2p_settlement_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sTerrainF2pSettlementRoomList;

    play->setupEntranceList = sTerrainF2pSettlementEntrances;
    play->linkActorEntry    = &sTerrainF2pSettlementPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sTerrainF2pSettlementLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomTerrainF2pSettlementScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&terrain_f2p_settlement_room_0_shapeHeader;
...
extern "C" int CustomTerrainF2pSettlementScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_TERRAIN_F2P_SETTLEMENT) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomTerrainF2pSettlementScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}

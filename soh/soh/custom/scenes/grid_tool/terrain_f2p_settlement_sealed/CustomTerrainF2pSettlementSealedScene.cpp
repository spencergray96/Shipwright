#include "CustomTerrainF2pSettlementSealedScene.h"
#include "global.h"
#include "z64scene.h"
#include "macros.h"
...
extern "C" {
    extern CollisionHeader terrain_f2p_settlement_sealed_scene_collisionHeader;
    extern RoomShapeNormal terrain_f2p_settlement_sealed_room_0_shapeHeader;
...
static EnvLightSettings sTerrainF2pSettlementSealedLightSettings[4] = {
...
static EntranceEntry sTerrainF2pSettlementSealedEntrances[] = {
    { 0, 0 },
};
...
static ActorEntry sTerrainF2pSettlementSealedPlayerSpawn = {
    ACTOR_PLAYER, { -6640, 13, -2960 }, { 0, -32768, 0 }, 0xDFF
};

static RomFile sTerrainF2pSettlementSealedRoomList[] = {
    { (uintptr_t)&terrain_f2p_settlement_sealed_room_0_shapeHeader,
      (uintptr_t)&terrain_f2p_settlement_sealed_room_0_shapeHeader + 256,
      nullptr },
};

extern "C" int CustomTerrainF2pSettlementSealedScene_IsCustomScene(s32 sceneId) {
    return sceneId == SCENE_TERRAIN_F2P_SETTLEMENT_SEALED;
}
...
static void InitScene(PlayState* play, s32 spawn) {
    ...
    BgCheck_Allocate(&play->colCtx, play, &terrain_f2p_settlement_sealed_scene_collisionHeader);

    play->numRooms = 1;
    play->roomList = sTerrainF2pSettlementSealedRoomList;

    play->setupEntranceList = sTerrainF2pSettlementSealedEntrances;
    play->linkActorEntry    = &sTerrainF2pSettlementSealedPlayerSpawn;
    ...
    play->envCtx.lightSettingsList = sTerrainF2pSettlementSealedLightSettings;

    Play_InitEnvironment(play, play->skyboxId);
    GameInteractor_ExecuteAfterSceneCommands(play->sceneNum);
}

extern "C" void CustomTerrainF2pSettlementSealedScene_InitRoom(PlayState* play, RoomContext* roomCtx) {
    roomCtx->curRoom.echo       = 0;
    roomCtx->curRoom.meshHeader = (MeshHeader*)&terrain_f2p_settlement_sealed_room_0_shapeHeader;
...
extern "C" int CustomTerrainF2pSettlementSealedScene_TrySpawn(PlayState* play, s32 sceneId, s32 spawn) {
    if (sceneId != SCENE_TERRAIN_F2P_SETTLEMENT_SEALED) {
        return 0;
    }
    ...
    SPDLOG_INFO("CustomTerrainF2pSettlementSealedScene: spawned scene {} spawn {}", sceneId, spawn);
    return 1;
}
